...
export function StatusBar() {
  ...
  return (
    <footer className="flex h-[var(--statusbar-h)] shrink-0 items-center justify-between border-t border-border bg-sidebar px-3 text-[11px] text-muted-foreground">
      ...
      <div>
        {appInfo.data?.name ?? "SSHBool"} {appInfo.data?.version ?? "…"}
      </div>
    </footer>
  )
}
